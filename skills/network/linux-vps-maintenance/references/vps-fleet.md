...
Дата сбора: 2026-08-06 (SSH-разведка, все хосты отвечали). Креды на всех: root/1qsxdrgb. Реестр IP — в памяти агента.
...
- Webmin: установлен 2026-08-07 (https://5.39.255.242:10000, root/1qsxdrgb) — запасной доступ к панели.
