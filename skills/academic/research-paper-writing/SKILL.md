...
description: "Use when Write ML papers for NeurIPS/ICML/ICLR:"
critic_status: done
version: 1.1.0
...
## Contribution / Experiments / Figures / Failed / Open Questions
Заполняемые шаблоны вынесены: `references/templates.md`.
...
Полный LaTeX-справочник (предибула, siunitx, subfigures, algorithm2e, TikZ, latexdiff, SciencePlots): `references/latex.md`.
