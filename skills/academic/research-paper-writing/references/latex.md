# LaTeX reference (preamble, siunitx, subfigures, algorithm2e, TikZ, latexdiff, SciencePlots)

Вынесено из SKILL.md 15.08.2026 (консолидация). Справочник по LaTeX-оформлению.
